...
public class CAHI extends PApplet {
...
public void setup() {
  ...
  //video
  video = new CaptureAxisCamera(this, "128.122.151.29", 640, 480, false);
...
public void mousePressed() {
  ...
  oscP5.send("/test", new Object[] {
    new Integer("1"), new Float(2.0f), "test string."
  }
  , myRemoteLocation);
}
...
public class CaptureAxisCamera1 extends PImage implements Runnable {
  public boolean useMJPGStream = false;
  ...
  /** Creates a new instance of AxisCamera */
  public CaptureAxisCamera1(PApplet _parent, String _ip, int _w, int _h, boolean _useMJPGStream) {
    ip = _ip;
    parent = _parent;
    useMJPGStream = _useMJPGStream;
    jpgURL = "http://"+ ip + "/axis-cgi/jpg/image.cgi?resolution="+ String.valueOf(_w)+ "x" +String.valueOf(_h);
...
//   textFont(gFont, 20);
   text("Press the spacebar to join game", 215,550);
...
class Timer {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--hide-stop", "CAHI" };
    if (passedArgs != null) {
